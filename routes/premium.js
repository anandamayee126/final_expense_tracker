...
const premium = express_1.default.Router();
...
premium.get('/showLeaderboard', auth_1.default, async (req, res) => {
...
premium.get('/checkPremium', auth_1.default, async (req, res) => {
    try {
...
premium.post('/downloadExpense', auth_1.default, async (req, res) => {
    try {
...
premium.post('/getdaily', auth_1.default, async (req, res) => {
    try {
...
premium.post('/getweekly', auth_1.default, async (req, res) => {
    try {
...
premium.post('/getMonthly', auth_1.default, async (req, res) => {
    try {
        if (req.user.isPremiumUser) {
...
premium.get('/pagination/:pageNo', auth_1.default, async (req, res) => {
    try {
    }
    catch (err) {
    }
