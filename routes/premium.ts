...
premium.get('/showLeaderboard',middleware,async(req:any,res:any)=>{
...
premium.get('/checkPremium' , middleware , async(req:any,res:any)=>{
    try{
 ...
 function uploadToS3(data: any, fileName: String)
{
    ...
    return new Promise((resolve, reject)=>{
        s3bucket.upload(params,(err:string,s3Response:any)=>{
            if(err){
...
premium.post('/downloadExpense',middleware, async(req:any, res:any) => {
    try{
    ...
    premium.post('/getdaily', middleware, async (req:any, res:any) => {
        try {
    ...
    premium.post('/getweekly', middleware, async (req:any, res:any) => {
        try {
    ...
    premium.post('/getMonthly', middleware, async (req:any, res:any) => {
        try {
            if (req.user.isPremiumUser) {
    ...
    premium.get('/pagination/:pageNo',middleware,async(req:any,res:any)=>{
        try{
